        ...
        public void handleMessage(@NonNull Message msg) {
            ...
            if (msg.what == ORDER_BOOK_GOT) {
                if (msg.obj != null) {
                    ...
                    Toast.makeText(tradeBuyFragmentWeakReference.get().getActivity(), R.string.can_not_get_market_order, Toast.LENGTH_LONG).show();
                }
                ...
                if ((msg.obj) instanceof OrderAdder.OrderError) {
                    ...
                    Toast.makeText(tradeBuyFragmentWeakReference.get().getActivity(), R.string.sent_order_successfully, Toast.LENGTH_LONG).show();
                }
            }
        }
    }
        ...
        public void handleMessage(@NonNull Message msg) {
            ...
            if (msg.what == ORDER_BOOK_GOT) {
                if (msg.obj != null) {
                    ...
                    Toast.makeText(tradeSellFragmentWeakReference.get().getActivity(), R.string.can_not_get_market_order, Toast.LENGTH_SHORT).show();
                }
            } else if (msg.what == ADD_ORDER) {
                if ((msg.obj) instanceof OrderAdder.OrderError) {
                    String errorText = ((OrderAdder.OrderError) msg.obj).getMessage();
                    ...
                    Float orderId = ((Order) msg.obj).getId();
                    // toDo manage Id here and save it.
                    Toast.makeText(tradeSellFragmentWeakReference.get().getActivity(), R.string.sent_order_successfully, Toast.LENGTH_SHORT).show();
                }
            }
        }
        ...
        public void handleMessage(@NonNull Message msg) {
            ...
            if (msg.what == WALLETS_GOT) {
                if (msg.obj != null) {
                    ...
                    Toast.makeText(walletFragmentWeakReference.get().getActivity(), R.string.error, Toast.LENGTH_SHORT).show();
                }
            }
        }
    }
        ...
        public void handleMessage(@NonNull Message msg) {
            ...
            if (msg.what == PROFILE_GOT) {
                if (msg.obj != null) {
                    ...
                    Toast.makeText(profileActivityWeakReference.get().getApplication(), R.string.done, Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(profileActivityWeakReference.get().getApplication(), R.string.error, Toast.LENGTH_SHORT).show();
                }
            } else if (msg.what == BANK_ACCOUNT_ADD) {
                Log.i("TAG", "Status:" + msg.obj);
                if (((String) msg.obj).equals("ok")) {
                    Toast.makeText(profileActivityWeakReference.get().getApplication(), R.string.bank_account_added,
                        Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(profileActivityWeakReference.get().getApplication(), R.string.add_bank_account_error,
                        Toast.LENGTH_SHORT).show();
                }
            } else if (msg.what == BANK_CARD_ADD) {
                Log.i("TAG", "Status:" + msg.obj);
                if (((String) msg.obj).equals("ok")) {
                    Toast.makeText(profileActivityWeakReference.get().getApplication(), R.string.bank_card_add,
                        Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(profileActivityWeakReference.get().getApplication(), R.string.add_bank_card_error,
                        Toast.LENGTH_SHORT).show();
                }
            }
        }
        ...
        public void handleMessage(@NonNull Message msg) {
            ...
            if (msg.what == NOBITEXT_NEWS_GOT) {
                if (msg.obj != null) {
                    ...
                    Toast.makeText(nobitexCryptoPriceFragmentWeakReference.get().getActivity(), R.string.error, Toast.LENGTH_SHORT).show();
                }
            }
            ...
            if (loginActivityWeakReference == null && splashScrActivityWeakReference == null) {
                ...
                if (msg.what == TOKEN_GOT) {
                    if (msg.obj != null) {
                        ...
                        Toast.makeText(loginActivityWeakReference.get(), R.string.wrong_username_or_password, Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(loginActivityWeakReference.get(), R.string.unknown_error, Toast.LENGTH_SHORT).show();
                }
