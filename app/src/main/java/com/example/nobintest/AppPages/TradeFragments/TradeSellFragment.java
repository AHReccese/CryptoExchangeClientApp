...
public class TradeSellFragment extends Fragment {
    ...
    private AppDataManager apppreferenceManager;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable final Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.fragment_trade_sell, null);
        ...
        apppreferenceManager = AppDataManager.getInstance(getContext());
        market = apppreferenceManager.getSellMarket();

        Button button = view.findViewById(R.id.sell_btn);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    EditText priceEditText = view.findViewById(R.id.sell_price);
                    EditText amountEditText = view.findViewById(R.id.sell_amount);
                    ...
                    if (!appDataManager.getProfileState().equals(AppDataManager.USER_STATE_SIGNED_IN)) {
                        Toast.makeText(getActivity(), R.string.sign_in_first, Toast.LENGTH_SHORT).show();
                    } else if (dataManager.isNetworkConnected(getActivity())) {
                        DataManager.SellPageHandler sellPageHandler = DataManager.getSellPageHandlerInstance();
                        sellPageHandler.setTradeSellFragmentWeakReference(new WeakReference<TradeSellFragment>(TradeSellFragment.this));

                        dataManager.addNewOrder("sell", "limit", tokens[0].toLowerCase(),
                            tokens[2].toLowerCase(), amountEditText.getText().toString(), priceEditText.getText().toString());
                    ...
                    //Toast.makeText(getContext(), "Sell request has been sent!", Toast.LENGTH_SHORT).show();
        ...
        header.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final ArrayList<String> arrayList = apppreferenceManager.getAllMarketList();
                ...
                builder.setItems(strings, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        apppreferenceManager.setSellMarket(selectedMarket);
    ...
    private void getGlobalOrders(String symbol) {
        ...
        if (dataManager.isNetworkConnected(getActivity())) {
            ...
            dataManager.getGlobalOrderBook(symbol, "SellPage");
