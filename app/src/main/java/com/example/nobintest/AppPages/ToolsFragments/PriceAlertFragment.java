            ...
            public void onClick(View v) {
                ...
                if (!serviceHasBeenStarted) {
                    ...
                    if (backGroundService == null) {
                        Toast.makeText(getContext(), R.string.connecting_to_service_try_later, Toast.LENGTH_LONG).show();
                    } else {

                        if (validRequest()) {
                            backGroundService.addSymbol(symbol, down.getText().toString(), up.getText().toString());
                        } else {
                            Toast.makeText(getContext(), R.string.invalid_input_values, Toast.LENGTH_LONG).show();
                        }
                    }
                }
