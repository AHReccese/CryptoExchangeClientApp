...
public class GraphActivity extends AppCompatActivity {
    ...
    private String underChartBarString;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        underChartBarString = getString(R.string.go_to_candle_chart);

        progressBar = findViewById(R.id.progress_bar);
        totalCount = findViewById(R.id.chart_total_count);
        totalVolume = findViewById(R.id.chart_total_volume);
        TextView chartSymbol = findViewById(R.id.chart_symbol);
    ...
    public void getCandles(Range range) {
        ...
        switch (range) {
            ...
            default:
                Toast.makeText(GraphActivity.this, R.string.invalid_state, Toast.LENGTH_SHORT).show();
                miniUrl = "";
                description = "";
